...
for code in codelist:
    codelist = code.split(" ")
    if len(codelist) == 4:
        code, big_region, small_region, small_region2 = codelist
        small_region += " " + small_region2
    else:
        code, big_region, small_region = codelist

    big_region_code = code[0:2]

    if big_region_code not in big_region_dict.keys():
        big_region_dict[big_region_code] = big_region
